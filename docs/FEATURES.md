...
Tracks what's implemented vs. planned, checkpoint by checkpoint. Updated as
...
- [x] Sprint 4 — MCP server (6 tools as Command classes)
...
- [ ] Sprint 6 — Streamlit UI, final README, full test/lint pass
